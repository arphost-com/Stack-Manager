...
const enhancedGuides = {
  ...
  'openbrain-mem0': {
    fit: 'Agent stack with durable memory (Mem0), knowledge graph (Neo4j), and workflow automation (n8n). The "memory + automation" flavour of OpenBrain.',
    setup: [
      ...
      'Uses pgvector (Postgres with vector extension) so Mem0 can do similarity search on memories.',
    ],
    caution: 'Heavier than OpenBrain #1 — plan for 8+ GB RAM. Mem0 needs OPENAI_API_KEY for memory extraction unless you configure it to use local Ollama.',
    links: [
